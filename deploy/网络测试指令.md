...
```bash
python3 -c "import requests; print(requests.get('https://ifconfig.me', timeout=10).text.strip())"
python3 -c "import requests; print(requests.get('https://ifconfig.me/ip', timeout=10).text.strip())"
```
